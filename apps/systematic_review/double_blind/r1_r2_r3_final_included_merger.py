...
class Stage2FullTextFinalInclusionAnalyzer:
    """
    Controller for final inclusion statistics and export of Stage 2 full-text
    ...
    def _init_paths(self) -> None:
        """
        Initialize and validate input/output paths under Stage 2 full-text directory.
        """
        # apps/systematic_review/double_blind/stage2_full_text/stage2_full_text_final_included_merger.py
    ...
    def load_results(self) -> pd.DataFrame:
        """
        Read Stage 2 full-text results and add normalized helper columns _R1 / _R2 / _R3.
    ...
    def run(self) -> None:
        ...
        1. Load Stage 2 full-text results.
...
def main() -> None:
    """
    Main entry point: run Stage 2 full-text final inclusion / exclusion
